...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dogHobbie: TextView? = view!!.findViewById(R.id.dog_hobbie)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogImage!!.setImageResource(dogList[position].imageResourceId)
        holder.dogName!!.text = dogList[position].name
        holder.dogAge!!.text = resources?.getString(R.string.dog_age, dogList[position].age)
        holder.dogHobbie!!.text = resources?.getString(R.string.dog_hobbies, dogList[position].hobbies)
    }
}
